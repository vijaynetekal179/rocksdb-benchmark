...
public class GrpcRedisClient {
    private static final String SERVER_IP = "127.0.0.1";
    private static final int SERVER_PORT = 9091; // Redis Server Port
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Starting gRPC Redis Benchmark Client...");
            ...
            new Thread(() -> {
                try {
                    ...
                    while (isRunning.get()) {
                        ...
                        // Stop sending more if we finished waiting and the timer is up
                        if (!isRunning.get()) {
                            break;
                        }
    ...
    private static void printResults(long startMs, long endMs, long totalOps,
        ...
        System.out.println("\n=== REDIS gRPC Network Benchmark Results ===");
        System.out.println("============================================");
